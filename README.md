...
Retrieval is FTS5 BM25 with RRF over category and constraint routes, including a precision AND of the leaf category token with a stated material or color. Reranking prefers exact phrases, IDF-weighted term coverage, category-path tokens, fiber-percentage matches, and typed color/material. An optional local MiniLM cosine is a light blend (weight 1.0) and is skipped when weights are missing.
