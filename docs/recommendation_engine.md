...
1. Over-fetch about 800 candidates with reciprocal-rank fusion of FTS routes.
...
If the fused list is short, category search and a rating-ordered catalog fallback fill unique ids. The fused depth is 800 of those same routes, not extra category-field indexes.
